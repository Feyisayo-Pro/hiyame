...
export default function CompanySignInScreen() {
  ...
  return (
    <SafeAreaView style={st.container} edges={['top', 'left', 'right', 'bottom']}>
      <PageHead title="Company Sign In" />
      ...
      >
        ...
        >
          ...
          <Animated.View style={[st.content, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            <Text style={st.subtitle}>Sign in to your hiring workspace</Text>
          ...
          <View style={st.footer}>
            <Pressable style={st.registerRow} onPress={() => router.push('/(auth)/register')}>
              <Text style={st.registerLabel}>Need a company account? </Text>
...
const makeStyles = (T: ThemePalette) => StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '800', color: T.textPrimary, letterSpacing: -0.3, marginBottom: 4, fontFamily: DISPLAY_FONT_FAMILY },
  ...
  securityNote: {
    ...
    marginTop: 20, backgroundColor: T.accentBg,
    paddingHorizontal: 14, paddingVertical: 12,
    borderRadius: 12, borderWidth: 1, borderColor: T.accentBg20,
  },
  securityText: { flex: 1, fontSize: 12, color: T.accentDim, lineHeight: 17, fontWeight: '500' },
