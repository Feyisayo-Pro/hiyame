...
// One-time (idempotent) setup: creates the public "company-logos" Storage
// bucket that api/upload-company-logo.ts uploads into. Mirrors
// create-photo-bucket.ts exactly. Run once against production:
// `npx tsx scripts/create-logo-bucket.ts`. Safe to re-run — it no-ops if the
